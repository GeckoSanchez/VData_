	...
	public static class Get
	{
			...
			try
			{
				...
				else
				{
					...
					if (name.StartsWith("op_", StringComparison.CurrentCultureIgnoreCase))
					{
						...
						else if (name.EndsWith("CheckedAddition"))
							Out = Kinds.BlockKind.CheckedAddition_Operator;
						else if (name.EndsWith("Addition"))
							Out = Kinds.BlockKind.Addition_Operator;
						else if (name.EndsWith("CheckedSubtraction"))
							Out = Kinds.BlockKind.CheckedSubtraction_Operator;
						else if (name.EndsWith("Subtraction"))
							Out = Kinds.BlockKind.Subtraction_Operator;
						else if (name.EndsWith("CheckedMultiply"))
							Out = Kinds.BlockKind.CheckedMultiplication_Operator;
						...
						else if (name.EndsWith("CheckedDivision"))
							Out = Kinds.BlockKind.CheckedDivision_Operator;
		...
		public static string Prefix(BlockKind type)
		{
			...
			try
			{
				Out = type switch
				{
					Kinds.BlockKind.None => "None",
					Kinds.BlockKind.Constructor => "Cstr",
					Kinds.BlockKind.Primary_Constructor => "PCtr",
					Kinds.BlockKind.Empty_Constructor => "ECtr",
					Kinds.BlockKind.Destructor => "Dstr",
					Kinds.BlockKind.Property => "Prop",
					Kinds.BlockKind.Field => "Fild",
					Kinds.BlockKind.Event => "Evnt",
					Kinds.BlockKind.Parameter => "Prgm",
					Kinds.BlockKind.Delegate => "Delg",
					Kinds.BlockKind.Function => "Func",
					Kinds.BlockKind.Override_Function => "OFun",
					Kinds.BlockKind.Static_Function => "SFun",
					Kinds.BlockKind.Virtual_Function => "VFun",
					Kinds.BlockKind.Page => "Page",
					Kinds.BlockKind.Component => "Comp",
					Kinds.BlockKind.Operator => "Oper",
					Kinds.BlockKind.Program => "Prog",
					Kinds.BlockKind.Get_Operator => "OprG",
					Kinds.BlockKind.Set_Operator => "OprS",
					Kinds.BlockKind.Addition_Operator => "Opr+",
					Kinds.BlockKind.Subtraction_Operator => "Opr-",
					Kinds.BlockKind.Multiplication_Operator => "Opr*",
					Kinds.BlockKind.Division_Operator => "Opr/",
					Kinds.BlockKind.Modulo_Operator => "Opr%",
					Kinds.BlockKind.Concat_Operator => "Op+=",
					Kinds.BlockKind.Explicit_Operator => "OpEx",
					Kinds.BlockKind.Implicit_Operator => "OpIm",
					Kinds.BlockKind.Equals_Operator => "Op==",
					Kinds.BlockKind.Not_Equals_Operator => "Op!=",
					Kinds.BlockKind.Lesser_Operator => "Opr<",
					Kinds.BlockKind.Greater_Operator => "Opr>",
					Kinds.BlockKind.Lesser_Or_Equals_Operator => "Op<=",
					Kinds.BlockKind.Greater_Or_Equals_Operator => "Op>=",
					Kinds.BlockKind.Init_Operator => "OpIn",
					Kinds.BlockKind.Increment_Operator => "Op++",
					Kinds.BlockKind.Decrement_Operator => "Op--",
					Kinds.BlockKind.Positive_Operator => "OpV+",
					Kinds.BlockKind.Negative_Operator => "OpV-",
					Kinds.BlockKind.Default => "Deft",
